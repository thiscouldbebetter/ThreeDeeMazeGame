...
class PlaceBuilder {
    ...
    static zonesBuild_Cell(maze, cellPos, cellPosInPixels, cellSizeInPixels, materialWall, materialRoomFloor, materialConnectorFloor, returnValues) {
        ...
        for (var n = 0; n < numberOfNeighbors; n++) {
            ...
            if (isCellCurrentConnectedToNeighbor) {
                ...
                if (isNeighborOdd) {
                    ...
                    var connectorPosInPixels = cellPos.clone().multiply(cellSizeInPixels).clone().add(Coords.fromXYZ(cellSizeInPixelsHalf.x, cellSizeInPixelsHalf.y, 0).multiply(neighborOffset));
