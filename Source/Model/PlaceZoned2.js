...
class PlaceZoned2 extends PlaceBase {
    ...
    static random(mazeSizeInCells, mazeCellSizeInPixels, randomizer, materialsByName) {
        ...
        var entityForPlayer = this.random_1_EntityForPlayer(maze, nameOfZoneStart, cellPosOfStart, meshMover);
        var entityForMoverOther = this.random_2_EntityForMoverOther(maze, nameOfZoneStart, cellPosOfStart, meshMover);
        var entityForChest = this.random_3_EntityForChest(maze, nameOfZoneStart, cellPosOfStart, materialsByName.get("Chest"), moverHeight);
        var entityForDoor = this.random_4_EntityForDoor(maze, nameOfZoneStart, cellPosOfStart, materialsByName.get("Door"), moverHeight);
    ...
    static random_1_EntityForPlayer(maze, nameOfZoneStart, cellPosOfStart, mesh) {
    ...
    static random_2_EntityForMoverOther(maze, nameOfZoneStart, cellPosOfStart, meshDefnMover) {
    ...
    static random_3_EntityForChest(maze, nameOfZoneStart, cellPosOfStart, material, moverHeight) {
    ...
    static random_4_EntityForDoor(maze, nameOfZoneStart, cellPosOfStart, materialDoor, moverHeight) {
