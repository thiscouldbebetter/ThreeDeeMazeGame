...
class Zone extends PlaceBase {
    ...
    static manyFromMaze_Cell(maze, cellPos, cellPosInPixels, cellSizeInPixels, materialWall, materialRoomFloor, materialConnectorFloor, returnValues) {
        var returnValuesByName = new Map();
    ...
    static manyFromMaze_Cell_Neighbors(maze, cellPos, cellCurrent, materialWall, materialFloor) {
        ...
        for (var n = 0; n < numberOfNeighbors; n++) {
            ...
            if (isCellCurrentConnectedToNeighbor) {
                ...
                if (isNeighborOdd) {
                    ...
                    var connectorPosInPixels = cellPos.clone().multiply(cellSizeInPixels).clone().add(new Coords(cellSizeInPixelsHalf.x, cellSizeInPixelsHalf.y, 0).multiply(neighborOffset));
                    var connectorSizeInPixels = new Coords((n == 1
